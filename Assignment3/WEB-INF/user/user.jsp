          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Useful Knowledge</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                        <h4 class="top-pad">Network</h4>
                        <hr>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse justo massa, elementum at tempus a, rhoncus pulvinar tortor. Nulla sit amet orci eget libero fermentum ultricies vitae consequat sem.</p>
                        <a href="#">View</a>
                    </div>
                    <div class="col-md-6">
                        <h4 class="top-pad">Software</h4>
                        <hr>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse justo massa, elementum at tempus a, rhoncus pulvinar tortor. Nulla sit amet orci eget libero fermentum ultricies vitae consequat sem.</p>
                        <a href="#">View</a>
                    </div>
                    <div class="col-md-6">
                        <h4 class="top-pad">Hardware</h4>
                        <hr>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse justo massa, elementum at tempus a, rhoncus pulvinar tortor. Nulla sit amet orci eget libero fermentum ultricies vitae consequat sem.</p>
                        <a href="#">View</a>
                    </div>
                    <div class="col-md-6">
                        <h4 class="top-pad">Email</h4>
                        <hr>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse justo massa, elementum at tempus a, rhoncus pulvinar tortor. Nulla sit amet orci eget libero fermentum ultricies vitae consequat sem.</p>
                        <a href="#">View</a>
                    </div>
                    <div class="col-md-6">
                        <h4 class="top-pad">Account</h4>
                        <hr>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse justo massa, elementum at tempus a, rhoncus pulvinar tortor. Nulla sit amet orci eget libero fermentum ultricies vitae consequat sem.</p>
                        <a href="#">View</a>
                    </div>
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Planned Maintenance</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <% out.print("<b> Current System Status: " +request.getAttribute("systemStatus")); %>
                  <% out.print("<b> Next Scheduled Maintenance: " +request.getAttribute("systemMaintenance")); %>
                </div>
              </div>
            </div>
          </div>
